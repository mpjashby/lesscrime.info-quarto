...
funding <- tribble(
  ...
  "Research project", "Benchmarking crime in London against other global cities", 2024, 2024, "£18,000", "Metropolitan Police Service", "Principal investigator",
  "Research project", "Stop and search disparity in Bedfordshire", 2025, 2026, "£20,000", "Bedfordshire Police", "Principal investigator"
) |> 
...
service <- tribble(
  ...
  "Sift judge for the Tilley Awards", 2023, 2025, "I am a judge for the initial round of the Tilley Awards for problem solving run by UK police forces", NA,
