...
if (!file.exists("police_workforce_pfa.csv")) {
  ...
  workforce_pfa <- read_ods(
    ...
    select(year = as_at_31_march, geocode, force_name, total_fte) |> 
    summarise(
      officers = sum(as.numeric(total_fte), na.rm = TRUE), 
      .by = c(year, geocode, force_name)
    )
...
police_pay <- tribble(
  ...
  # Home Office is proposing a 3.5% pay increase for all ranks
...
Source: [Institute for Government](https://www.instituteforgovernment.org.uk/publication/performance-tracker-2023/police).
...
Source: [Home Office](https://www.gov.uk/government/statistics/police-workforce-england-and-wales-31-march-2023)
...
Source: [Office for National Statistics](https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/datasets/crimeinenglandandwalesappendixtables)
...
crime_severity_raw <- severity |> 
  ...
  left_join(workforce_pfa, by = c("code" = "geocode", "year")) |> 
...
Source: [Office for National Statistics](https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/datasets/crimeseverityscoreexperimentalstatistics)
...
Source: Home Office, [before 2015](https://www.gov.uk/government/statistics/crime-outcomes-in-england-and-wales-2014-to-2015) and [since 2015](https://www.gov.uk/government/statistics/crime-outcomes-year-to-december-2023-data-tables)
...
Souce: [Office for National Statistics](https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/datasets/crimeinenglandandwalesannualsupplementarytables)
...
Population data for [England and Wales](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/timeseries/ewpop/pop) and for [local authority districts](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/datasets/populationestimatesforukenglandandwalesscotlandandnorthernireland) (which can be used to create estimates for police-force areas) are mid-year estimates from the Office for National Statistics. [Inflation data are from the Bank of England](https://www.ons.gov.uk/generator?format=csv&uri=/economy/inflationandpriceindices/timeseries/l522/mm23).
